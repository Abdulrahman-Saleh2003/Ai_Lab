...
// // GET /api/lab-reports/result/{job_id}/
// // ═══════════════════════════════════════════════════════════
//
// class LabTest {
//   final String alias;
...
// }
//
// /// حالة التقرير بقائمة كل التقارير (مختلفة عن حالة الـ job بالـ polling)
// enum ReportStatus {
//   pending,
//   processing,
//   completed,
...
class LabReportItem {
  ...
  // ✅ جديد: حالة التحليل بالـ AI ونتيجته (قادمة من /patients/my-reports/all/)
  ...
  // ✅ جديد: مشان نحدّث تقرير معيّن بالليست بعد ما يخلص تحليله
